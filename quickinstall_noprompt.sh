...
apt install -y php-fpm php-mysql php-intl php-xml php-xmlrpc libphp-phpmailer php-mbstring php-common php-curl php-pear php-gd php-zip php-dev php-soap php-mbstring libpcre2-dev zlib1g-dev
