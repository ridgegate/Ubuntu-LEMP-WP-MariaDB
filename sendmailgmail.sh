...
touch /etc/mail/authinfo/smtpacct
echo "AuthInfo: \"U:F2BAlert\" \"I:$F2B_SENDER_EMAIL\" \"P:$F2B_SENDER_PASS\"" > /etc/mail/authinfo/smtpacct
makemap hash  /etc/mail/authinfo/smtpacct <  /etc/mail/authinfo/smtpacct
rm -f /etc/mail/authinfo/smtpacct
