...
read -p "Enter domain name: " CERT_NAME
clear
...
sudo apt-get install -y sendmail mailutils sendmail-bin iptables-persistent
...
rm gmail-auth
sed -i "s/CERTNAME/$CERT_NAME/" /etc/mail/sendmail.mc
